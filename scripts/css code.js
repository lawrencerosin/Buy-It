...
const ORDER_COMPLETION="<style>#order-completion{display:flex;}#finish{background-color:lightgreen;} #cancel{background-color:orange;}</style>";
module.exports={BODY, LIST, TABLE, DELETE_BUTTON, ORDER_COMPLETION};